  ...
  return (
    <div className="card-container">
      <div className="card">
        <div className="front">
          <div className="cover">
            <img src="https://cdn.pixabay.com/photo/2016/11/29/07/16/balancing-1868051_1280.jpg" alt="Cover"  />
          </div>
          <div className="user">
            <img className="img-circle" src="https://cdn.pixabay.com/photo/2015/01/08/18/29/entrepreneur-593358_1280.jpg" alt="User" height={150} width={150}/>
          </div>
          <div className="content">
            <div className="main">
              <h3 className="name">Glenn Smith</h3>
              <p className="profession">Associate Manager</p>
