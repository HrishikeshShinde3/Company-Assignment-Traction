  ...
  return (
    <div className="card-container">
      <div className="card">
        <div className="front">
          <div className="cover">
            <img src="https://cdn.pixabay.com/photo/2018/03/06/03/56/cyclist-3202481_1280.jpg" alt="Cover"  />
          </div>
          <div className="user">
            <img className="img-circle" src="https://cdn.pixabay.com/photo/2017/08/01/11/48/woman-2564660_1280.jpg" alt="User" height={150} width={150}/>
          </div>
          <div className="content">
            <div className="main">
              <h3 className="name">Suzi Bates</h3>
              <p className="profession">Bussiness Analyst</p>

              <p className="text-center">
              “Just one small positive thought in the morning can change your whole day.”               </p>
            </div>
