  ...
  return (
    <div className="card-container">
      <div className="card">
        <div className="front">
          <div className="cover">
            <img src="https://cdn.pixabay.com/photo/2016/11/08/05/20/sunset-1807524_1280.jpg" alt="Cover"  />
          </div>
          <div className="user">
            <img className="img-circle" src="https://cdn.pixabay.com/photo/2015/05/03/14/40/woman-751236_1280.jpg" alt="User" height={150} width={150}/>
          </div>
          <div className="content">
            <div className="main">
              <h3 className="name">Alica Capsey</h3>
              <p className="profession">Application Manager</p>
